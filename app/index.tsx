...
import { AppHeader, Card, Metric, PrimaryButton, SectionTitle } from '@/components/ui';
...
export default function Home(){
  ...
  return <SafeAreaView style={s.safe}><ScrollView refreshControl={<RefreshControl refreshing={loading} onRefresh={load}/>} contentContainerStyle={s.container}>
    <AppHeader title="Mijoty"/><Text style={s.hello}>Bonjour {memberName||''} 👋</Text><Text style={s.sub}>Vos données sont maintenant synchronisées avec Supabase.</Text>
