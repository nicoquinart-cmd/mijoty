...
const styles=StyleSheet.create({
  ...
  headerTitle:{fontSize:30,fontWeight:'900',color:colors.brown},
  headerSubtitle:{color:colors.muted,marginTop:6,lineHeight:20},
  versionBadge:{backgroundColor:colors.softTerracotta,borderRadius:999,paddingHorizontal:10,paddingVertical:5,marginTop:3},
  versionText:{fontSize:12,fontWeight:'900',color:colors.terracotta},
